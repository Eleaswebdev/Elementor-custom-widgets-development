<?php 
   function avocado_product_list1( ) {
    ...
    function avocado_product_cat_list1( ) {
...
class Be_ProductCat_Widget extends \Elementor\Widget_Base {

        public function get_name() {
            return 'be-product-category';
        }
        
        public function get_title() {
            return __( 'Be ProductCategory', 'ppm-quickstart' );
        }
        ...
        protected function _register_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => \Elementor\Controls_Manager::SELECT2,
                    'multiple' => true,
                    'options' => avocado_product_cat_list1(),
                    'condition' => [
                        'from' => 'category',
                    ],
                ]
