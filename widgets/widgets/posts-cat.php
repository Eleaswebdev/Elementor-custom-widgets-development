...
class Be_Postcat_Widget extends \Elementor\Widget_Base {

        public function get_name() {
            return 'be-posts-category';
        }
        
        public function get_title() {
            return __( 'Be PostsCategory', 'ppm-quickstart' );
        }
