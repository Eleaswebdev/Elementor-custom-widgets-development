<?php
class BeWidget_Shortcode extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'BeShortcode', 'plugin-name' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_shortcode',
			[
				'label' => __( 'Be Shortcode', 'plugin-name' ),
			]
		);
		...
		$this->add_control(
			'shortcode',
			[
				'label' => __( 'Insert your shortcode here', 'plugin-name' ),
