...
final class RRF_Commerce_Extension {
	...
	public function init() {
		...
		add_action( 'elementor/widgets/widgets_registered', [ $this, 'widget_styles' ] );
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/product-cat.php' );
		require_once( __DIR__ . '/widgets/posts-cat.php' );
		require_once( __DIR__ . '/widgets/posts-product.php' );
		require_once( __DIR__ . '/widgets/product-carousel.php' );
		require_once( __DIR__ . '/widgets/single-product-carousel.php' );
		require_once( __DIR__ . '/widgets/BeShortcode.php' );
		require_once( __DIR__ . '/widgets/BeProductHover.php' );
		require_once( __DIR__ . '/widgets/Product-Tab.php' );
		//require_once( __DIR__ . '/widgets/posts.php' );
		//require_once( __DIR__ . '/widgets/Beposts.php' );
		...
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BEPosts_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_Gallery_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_ProductCat_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_Postcat_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_PostProduct_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_ProductCarousel_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_SingleProductCarousel_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BeWidget_Shortcode() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_ProductHoverCard_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_ProductTab_Widget() );
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Be_Posts_Widget() );
	...
	public function widget_styles(){
		...
		wp_enqueue_style('gallery-css', plugins_url('widgets/css/gallery.css', __FILE__) );
	} 
...
function be_toolkit_scripts() {
	//wp_enqueue_style( 'slick', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css', array(), '20151215' );
    wp_enqueue_style( 'avacado-toolkit', plugin_dir_url( __FILE__ ) . '/assets/css/avocado-toolkit.css', array(), '20151215' );
    
    //wp_enqueue_script( 'slick', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', array(), '20151215', true );
}
add_action( 'wp_enqueue_scripts', 'be_toolkit_scripts' );